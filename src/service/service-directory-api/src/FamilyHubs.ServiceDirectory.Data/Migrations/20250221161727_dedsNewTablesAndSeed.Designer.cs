...
namespace FamilyHubs.ServiceDirectory.Data.Migrations
{
    ...
    [Migration("20250221161727_dedsNewTablesAndSeed")]
    partial class dedsNewTablesAndSeed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FamilyHubs.SharedKernel.OpenReferral.PrototypeEntities.StandardVersion", b =>
                {
                    b.Property<byte>("Id")
                        .HasColumnType("tinyint");
                    ...
                    b.ToTable("StandardVersions", "deds");

                    b.HasData(
                        new
                        {
                            Id = (byte)1,
                            Name = "Open Referral UK V2"
                        },
                        new
                        {
                            Id = (byte)2,
                            Name = "Open Referral International V3.0"
                        });
                });

            modelBuilder.Entity("FamilyHubs.SharedKernel.OpenReferral.PrototypeEntities.ThirdParty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("OpenReferralUrl")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");

                    b.HasKey("Id");

                    b.ToTable("ThirdParties", "deds");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Name = "MockHsds",
                            OpenReferralUrl = "https://dfe-mock-hsds.com"
                        });
                });

            modelBuilder.Entity("FamilyHubs.SharedKernel.OpenReferral.PrototypeEntities.ThirdPartyService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<byte>("StandardVersionId")
                        .HasColumnType("tinyint");
                    ...
                    b.HasAlternateKey("ServiceId", "ThirdPartyId");
                    ...
                    b.ToTable("ThirdPartyServices", "deds");
                });
            ...
            modelBuilder.Entity("FamilyHubs.SharedKernel.OpenReferral.PrototypeEntities.ThirdPartyService", b =>
                {
                    b.HasOne("FamilyHubs.SharedKernel.OpenReferral.PrototypeEntities.StandardVersion", null)
                        .WithMany()
                        .HasForeignKey("StandardVersionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FamilyHubs.SharedKernel.OpenReferral.PrototypeEntities.ThirdParty", null)
                        .WithMany()
