...
{
    [JsonPropertyName("location_type")] public required string LocationType { get; init; }
    ...
    [JsonPropertyName("transportation")] public string? Transportation { get; init; }
    ...
    [JsonPropertyName("addresses")] public List<Address> Addresses { get; init; } = new();

    [JsonPropertyName("contacts")] public List<Contact> Contacts { get; init; } = new();

    [JsonPropertyName("accessibility")] public List<Accessibility> Accessibilities { get; init; } = new();
