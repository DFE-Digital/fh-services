...
public class Organization : BaseHsdsEntity
{
    ...
    [JsonPropertyName("legal_status")] public required string LegalStatus { get; init; }
    ...
    [JsonPropertyName("locations")] public List<Location> Locations { get; init; } = new();

    [JsonPropertyName("programs")] public List<Program> Programs { get; init; } = new();
