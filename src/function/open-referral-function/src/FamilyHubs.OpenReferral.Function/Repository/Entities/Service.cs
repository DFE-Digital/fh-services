...
public class Service : BaseHsdsEntity
{
    ...
    [JsonPropertyName("organization")] public Organization? Organization { get; init; }

    [JsonPropertyName("program_id")]
    [JsonIgnore]
    public Guid ProgramId { get; init; }
    [JsonPropertyName("program")] public Program? Program { get; init; }
    ...
    [JsonPropertyName("fees_description")] public string? FeesDescription { get; init; }

    [JsonPropertyName("accreditations")] public string? Accreditations { get; init; }

    [JsonPropertyName("eligibility_description")]
    public string? EligibilityDescription { get; init; }

    [JsonPropertyName("minimum_age")] public byte MinimumAge { get; init; }

    [JsonPropertyName("maximum_age")] public byte MaximumAge { get; init; }

    [JsonPropertyName("assured_date")] public DateTime? AssuredDate { get; init; }

    [JsonPropertyName("assurer_email")] public string? AssurerEmail { get; init; }

    [JsonPropertyName("alert")] public string? Alert { get; init; }

    [JsonPropertyName("last_modified")] public DateTime? LastModified { get; init; }
    ...
    [JsonPropertyName("service_areas")] public List<ServiceArea> ServiceAreas { get; init; } = new();
    ...
    [JsonPropertyName("funding")] public List<Funding> Funding { get; init; } = new();

    [JsonPropertyName("cost_options")] public List<CostOption> CostOptions { get; init; } = new();
