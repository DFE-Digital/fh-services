...
public class TaxonomyTerm : BaseHsdsEntity
{
    ...
    [JsonPropertyName("parent_id")] public Guid? ParentId { get; init; }

    [JsonPropertyName("taxonomy")] public string? Taxonomy { get; init; }
    ...
    [JsonPropertyName("term_uri")] public string? TermUri { get; init; }
