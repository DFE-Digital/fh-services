...
| REFERRAL-API-AZURE-WEBAPP-PUBLISH-PROFILE | Azure App Service Publish Profile String | Publish profile for Connect API app service | Publish profile for the Referral API app service |
